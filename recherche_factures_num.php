...
<body class="with-side-menu">
	...
	<div class="page-content">
			...
			<div class="box-typical box-typical-padding">
				...
				<div class="row">
						...
						<fieldset class="form-group">
							<label class="form-label" for="exampleInputEmail1">N° Factures</label>
							<input name="factures" onchange="validation_devis()" type="text" class="typeahead form-control" id="article"  >
						</fieldset>
					</div>
		...
		<label class="form-label semibold" for="exampleInput">&nbsp;</label>
                            <a style="float:right;" class="btn btn-rounded btn-inline" onclick="recherche_factures()">Rechercher</a>
	...
	function recherche_factures() {
                            
                               str1=document.forms['entete'].factures.value;
 
                showLoadingImage();
				
				window.location.replace("facture.php?q="+str1);
...
<script src="js/app.js"></script>
	...
	$("input.typeahead").typeahead({
        ...
        return $.get('ajax/list_factures.php', { query: query }, function (data) {
