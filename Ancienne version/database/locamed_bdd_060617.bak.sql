...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 06 Juin 2017 à 15:41
...
(3, 2, 'Saisie Devis', '', 'creation_devis.php', 0),
...
(8, 0, 'Gestion Logistique', '', '', 0),
(9, 8, 'Liste des Bon de Livraisons', '', 'list_bl.php', 0),
(10, 8, 'Validation BL', '', 'validation_bl.php', 0),
(11, 0, 'Gestion des Retours', '', '', 0),
(12, 11, 'Saisie Retour', '', 'creation_retour.php', 0),
(13, 11, 'Liste des Retours', '', 'list_retour.php', 0);
...
--
ALTER TABLE `menu`
  MODIFY `id_menu` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
