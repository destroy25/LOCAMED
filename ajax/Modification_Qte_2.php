...
$client = new nusoap_client($wsdl,true);
	...
	array('num'=>$num,'Type'=>0,'item'=>$item,'Qte'=>$Qte,'i'=>$_SESSION['Objet_cnx'],'NameSage'=>$_SESSION['NameSage'],'PwdSage'=>$_SESSION['PwdSage']));
...
<input type="hidden" id="num_piece" value="'.$num.'"/>
	...
	<div  class="col-lg-12">
							<table class="table table-bordered">
								<thead>
									<tr>
										<th width="10"><a class="SelectModif_2" href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil"></i></a>
						...
						echo'
									<tr id="'.$dat['cbMarq'].'" class="'.$id.'" >
										...
										<td><input class="form-control" type="text" onchange="Modification_Remise_2('.$id.')" id="Remise'.$id.'" value="'.number_format($dat['DL_Remise01REM_Valeur'],0,'',' ').'" /></td>
