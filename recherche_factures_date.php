...
<body class="with-side-menu">
	...
	<div class="page-content">
			...
			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3>Recherche Facture</h3>
							<ol class="breadcrumb breadcrumb-simple">
								<li><a href="#">Gestion Facture</a></li>
								<li><a href="#">Recherche Facture</a></li>
							</ol>
						</div>
					</div>
				</div>
		...
		<label class="form-label semibold" for="exampleInput">&nbsp;</label>
                            <a style="float:right;" class="btn btn-rounded btn-inline" onclick="recherche_facture()">Rechercher</a>
	...
	function recherche_facture() {
				...
				window.location.replace("list_factures.php?client="+str1+"&debut="+str2+"&fin="+str3);
