	...
	<div class="page-content">
			...
			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3>Validation Livraison</h3>
							<ol class="breadcrumb breadcrumb-simple">
								<li><a href="#">Gestion Logisitique</a></li>
								<li><a href="#">Validation Livraison</a></li>
							</ol>
						</div>
					</div>
				</div>
...
?>
	   ...
	   <form  action="validation_livraison.php" method="POST">

											<div class="col-lg-4">
						<fieldset class="form-group">
							<label class="form-label" for="exampleInputEmail1">Code à Barre - Bon de Livraison</label>
							<input name="bl" type="text" class="typeahead form-control" id="article"  >
						</fieldset>
					</div>
